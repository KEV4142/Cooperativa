...
public class frmBodega extends javax.swing.JInternalFrame {
     ...
     */
    public frmBodega(ControlUniversal cont) {
        initComponents();
        control=cont;
        txtCampos.add(txtBodegaID);
        txtCampos.add(txtNombre);
        bodega=new Bodega();
        int auto = control.autoUniversal2("Bodega","BodegaID");
    ...
    private void initComponents() {
        ...
        txtBodegaID.setBackground(java.awt.Color.white);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            bodega=new Bodega();
            Object o[][]=control.seekUniversal(bodega.getVectorData(), "Bodega",x+"");
            if(o!=null){
                bodega = new Bodega(o);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(a){
            ...
            if(ins){
                control.insUniversal(bodega.getVectorData(), "Bodega");
            }
            else{
                control.updUniversal(bodega.getVectorData(),"Bodega",txtBodegaID.getText().trim());
            }
            Limpiar_Campos();
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(!ins){
            ...
            if (res == JOptionPane.YES_OPTION) {
                control.delUniversal(bodega.getVectorData(), "Bodega", txtBodegaID.getText().trim());
                Limpiar_Campos();
            }
        }
