...
public class frmCompra extends javax.swing.JInternalFrame {
     ...
     */
    public frmCompra(ControlUniversal cont) {
        control=cont;
        titulos=new Vector();
        ...
        int auto = control.autoUniversal2("CompraCab","CompraID");
    ...
    private void validActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validActionPerformed
        if(!b){
            ...
            JOptionPane.showMessageDialog(rootPane,"Campo No. de Factura se encuentra Vacio","Error",JOptionPane.ERROR_MESSAGE);
            txtFacturaID.grabFocus();
        }
        else{
            String d="";
            ...
            compracab=new CompraCab(inter.String_Int(txtCompraID.getText()),inter.String_Int(txtProveedorID.getText()),inter.String_Int(txtBodegaID.getText()),txtFecha.getText(),inter.String_Int(txtFacturaID.getText()),"G",d);
            ins=true;
            txtArticuloID.grabFocus();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(!ins){
            ...
            if(res==JOptionPane.YES_OPTION){
                boolean y=control.insUniversal2(compracab.getVectorData(), "CompraCab");
                boolean x=false;
