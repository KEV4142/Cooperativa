...
public class frmProveedor extends javax.swing.JInternalFrame {
    ...
    public frmProveedor(ControlUniversal cont) {
        initComponents();
        control=cont;
        ...
        txtCampos.add(txtDias);
        proveedor=new Proveedor();
        int auto = control.autoUniversal2("Proveedor","ProveedorID");
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtDias, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 230, 90, -1));

        txtProveedorID.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.highlight"));
        ...
        getContentPane().add(txtContacto, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 260, -1));
        ...
        getContentPane().add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 90, -1));
        ...
        getContentPane().add(txtLimite, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 90, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 280, 80, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 110, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 280, 100, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 280, 100, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            proveedor=new Proveedor();
            Object o[][]=control.seekUniversal(proveedor.getVectorData(), "Proveedor",x+"");
            if(o!=null){
                ...
                txtDias.setText(proveedor.getDias()+"");
                txtNombre.grabFocus();
                ins = false;
            }
        } catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (a) {
            proveedor = new Proveedor(inter.String_Int(txtProveedorID.getText()), txtNombre.getText().toUpperCase(), txtDireccion.getText().toUpperCase(),txtContacto.getText().toUpperCase(),txtTelefono.getText(), inter.String_Float(txtLimite.getText()), inter.String_Int(txtDias.getText()));
            if (ins) {
                control.insUniversal(proveedor.getVectorData(), "Proveedor");
            } else {
                control.updUniversal(proveedor.getVectorData(), "Proveedor", txtProveedorID.getText().trim());
            }
            Limpiar_Campos();
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(!ins){
            ...
            if (res == JOptionPane.YES_OPTION) {
                control.delUniversal(proveedor.getVectorData(), "Proveedor", txtProveedorID.getText().trim());
                Limpiar_Campos();
            }
        }
